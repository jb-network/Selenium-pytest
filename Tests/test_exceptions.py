...
class TestExceptions:
    ...
    def test_no_such_element_exception(self, browser):
        exceptions_page = ExceptionsPage(browser)
        exceptions_page.open()
        exceptions_page.add_second_row()
        assert exceptions_page.is_row2_displayed(),"Row 2 input should be displayed, but it is is not"


    @pytest.mark.exceptions
    def test_element_not_interactable_exception(self, browser):
        exceptions_page = ExceptionsPage(browser)
        exceptions_page.open()
        exceptions_page.add_second_row()
    ...
    @pytest.mark.exceptions
    def test_invalid_element_state_exception(self, browser):
        exceptions_page = ExceptionsPage(browser)
        exceptions_page.open()
    ...
    @pytest.mark.exceptions
    def test_stale_element_reference_exception(self, browser):
        exceptions_page = ExceptionsPage(browser)
        exceptions_page.open()
        exceptions_page.add_second_row()
    ...
    @pytest.mark.debug
    @pytest.mark.exceptions
    def test_timeout_exception(self, browser):
        exceptions_page = ExceptionsPage(browser)
        exceptions_page.open()
        exceptions_page.add_second_row()
        assert exceptions_page.is_row2_displayed(), "Row 2 input should be displayed, but it is is not"
